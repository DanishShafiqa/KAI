...
const JadwalPage =async(myProp:Props)=>{
    const departure_location= (await myProp.searchParams).departured_location?.toString()||""
    ...
    return(
        <div className="w-full p-3">
            <div className="bg-blue-600 w-full p-3 rounded-md shadow-md">
                <h1 className="text-white text-xl font-bold">Pemesanan Tiket Kereta Api</h1>
                <FilterJadwal 
                    departuredLocation={departure_location}
            ...
            </div>
            {
                ...
                <div className="my-3">
                        ...
                        {
                            dataJadwal.length==0?
                            <div className="w-full p-3 rounded-md bg-orange-100">Maaf, jadwal tidak tersedia</div>:
                            <div>{dataJadwal.map((jadwal, index)=>(
