...
// function to call detail kereta that include gerbong dan kursi
const getDetailKereta = async(id_kereta: string): Promise<KeretaTypes | null>=>{
    try {
    ...
    return(
        <div className="w-full p-3">
            ...
            <div className="bg-yellow-100 rounded-md p-3">
                ...
                <p className="text-xl text-slate-500">Data kereta tidak ditemukan.</p>
            </div>:
            <div className="text-sm">
                <h1 className="text-lg font-semibold">{dataKereta.name}</h1>
                <p>{dataKereta.descriptions}</p>
