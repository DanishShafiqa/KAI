...
const AddGerbong=(myProp: props)=>{
    ...
    return(
        <div>
            <ToastContainer
            containerId={`toastAddGerbong`}/>
            <button type="button" onClick={()=>openModal()}className="px-4 py-2 rounded-md bg-green-600 hover:bg-green-500 text-white">Tambah Gerbong</button>
            <Modal isShow={show}>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="w-full p-3">
                        ...
                        <div className="my-2 border rounded-md p-3">
                            ...
                            <input type="number" id={`seat_count`} value={seat_count.toString()} onChange={e=>setSeatCount(Number(e.target.value))} required={true} className="w-full p-1 outline-none focus:border-b-sky-600 focus:border-b"/>
                        </div>
                    </div>
                    {/* Modal footer */}
