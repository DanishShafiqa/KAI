...
const AddKereta = ()=>{
    ...
    return(
        <div>
            ...
            <button type="button" onClick={()=>openModal()} className="px-4 py-2 rounded-md bg-lime-600 hover:bg-lime-500 text-white">Tambah Data Kereta</button>
            <Modal isShow={show}>
                <form onSubmit={e=> handleSubmit(e)}>
                    ...
                    <div className="w-full p-3">
                        ...
                        <div className="my-2 border rounded-md p-3">
                            ...
                            <input type="text" id={`descriptions`} value={descriptions} onChange={e=>setDescriptions(e.target.value)} required={true} className="w-full p-1 outline-none focus:border-b-sky-600 focus:border-b"/>
                        </div>
                        <div className="my-2 border rounded-md p-3">
                            <small className="text-sm fonst-semibold text-sky-600">Tipe Kereta</small>
                            <input type="text" id={`type`} value={type} onChange={e=>setType(e.target.value)} required={true} className="w-full p-1 outline-none focus:border-b-sky-600 focus:border-b"/>
                        </div>
                    </div>
                    {/* Modal footer */}
